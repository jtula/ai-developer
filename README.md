...
1. [Python Backend & APIs](./01-python-backend.md)
2. [LLMs y Prompt Engineering](./02-llms-y-prompts.md)
3. [Agentes y Tools](./03-agentes-y-tools.md)
4. [LangChain & LangGraph](./04-langchain-langgraph.md)
5. [RAG (Retrieval-Augmented Generation)](./05-rag.md)
6. [Análisis de Código Legacy](./06-codigo-legacy.md)
